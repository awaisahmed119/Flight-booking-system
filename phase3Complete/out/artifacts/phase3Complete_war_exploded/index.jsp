<%@ page import="com.eL.webproject.DisplayFlightServlet" %>
<!DOCTYPE html>
<html>
...
<form name="temp" action="<%=response.encodeURL(request.getContextPath()+"/home")%>"  method="post"  >
<script>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <form action="<%=response.encodeURL(request.getContextPath()+"/displayflight")%>" method="post">
                <button type="submit" class="btn btn-primary navbar-btn" value="admin" name="button" >Manage Flights</button>
            </form>
        </div>
        <form action="<%=response.encodeURL(request.getContextPath()+"/displayflight")%>" method="post">
            <button type="submit" class="btn btn-success navbar-btn" value="manager" name="button" >Show Requests of admin</button>
        </form>
         ...
         <!--   <div class="collapse navbar-collapse" id="navcol-1"><a class="btn btn-primary navbar-btn" role="button" type="submist" href="admin.jsp">Manage Flights </a><a class="btn btn-success navbar-btn" role="button" href="manager.jsp" style="margin-left:0.7%;">Show Requests</a>-->
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="active" role="presentation"><a href="login.jsp">Login </a></li>
                    <li role="presentation"><a href="regestration.jsp">Signup </a></li>
